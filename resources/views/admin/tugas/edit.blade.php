            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="txtnama_tugas" value="{{$data->nama_tugas}}" placeholder="Tuliskan nama tugas" class="form-control"><small class="form-text text-muted"></small></div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="txtketerangan_tugas" value="{{$data->ket_tugas}}" placeholder="Tuliskan nama tugas" class="form-control"><small class="form-text text-muted"></small></div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col col-md-9">
                            <div class="form-check-inline form-check">
                                <label for="inline-radio1" class="form-check-label ">
                                    <input type="radio" id="inline-radio1" name="radiostatus_tugas" value=0
                                    {{$data->status_tugas==0 ? "checked" : ""}} class="form-check-input">Masih Berjalan
                                </label>
                                <label for="inline-radio2" class="form-check-label ">
                                    <input type="radio" id="inline-radio2" name="radiostatus_tugas" value=1
                                    {{$data->status_tugas==1 ? "checked" : ""}} class="form-check-input">Selesai
                                </label>
                            </div>
                        </div>
                    </div>
