            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    @endif
                        ...
                        <form action="{{route('uts.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Mata Kuliah</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="txtmata_kuliah" placeholder="Tuliskan nama mata kuliah" class="form-control"><small class="form-text text-muted"></small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Dosen</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_dosen" placeholder="Tuliskan nama dosen" class="form-control"><small class="form-text text-muted"></small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Hari</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_hari" placeholder="Tuliskan nama hari" class="form-control"><small class="form-text text-muted"></small></div>
                    </div>
