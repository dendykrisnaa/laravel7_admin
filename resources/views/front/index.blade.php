...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{asset('public/front/')}}https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="{{asset('public/front/')}}https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
</head>
    ...
    <div class="container">
        <div class="header-section">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="logo">
                        <a href="#"><img src="{{asset('public/front/assets/img/logo.png')}}" alt="Tech NewsLogo"></a>
                    </div>
                    <!-- Logo Section -->
                </div>
                <div class="col-md-4">
